...
import * as controller from "../controllers/action.controller.js";
...
router.post(
  ...
  rateLimitByUser(RATE_LIMIT_ACTION.CREATE_ACTION),
...
router.put(
  ...
  rateLimitByUser(RATE_LIMIT_ACTION.UPDATE_ACTION),
...
router.delete(
  ...
  rateLimitByUser(RATE_LIMIT_ACTION.DELETE_ACTION),
  controller.remove,
);
