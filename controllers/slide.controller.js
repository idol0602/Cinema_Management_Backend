import * as service from "../services/slide.service.js";
...
export const create = async (req, res, next) => {
  try {
    if (req.file) {
      ...
      const { url } = await uploadBase64(req.body.image, "cinema_slides");
      req.body.image = url;
    }
    ...
    return success(res, data, "Create slide successfully", 201);
  } catch (e) {
    next(e);
  }
};
...
export const getAll = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get slides successfully");
  } catch (e) {
    next(e);
  }
};
...
export const getById = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get slide successfully");
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Update slide successfully");
  } catch (e) {
    next(e);
  }
};
...
export const remove = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Remove slide successfully");
  } catch (e) {
    next(e);
  }
};
