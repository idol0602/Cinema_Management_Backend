...
export const create = async (req, res, next) => {
  try {
    if (req.file) {
      ...
      const { url } = await uploadBase64(req.body.image, "cinema_events");
      req.body.image = url;
    }
    ...
    return success(res, data, "Create event successfully", 201);
  } catch (e) {
    next(e);
  }
};
...
export const getAll = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get events successfully");
  } catch (e) {
    next(e);
  }
};
...
export const getById = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get event successfully");
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Update event successfully");
  } catch (e) {
    next(e);
  }
};
...
export const remove = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Remove event successfully");
  } catch (e) {
    next(e);
  }
};
