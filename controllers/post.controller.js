...
export const create = async (req, res, next) => {
  try {
    if (req.file) {
      ...
      const { url } = await uploadBase64(req.body.image, "cinema_posts");
      req.body.image = url;
    }
    ...
    return success(res, data, "Create post successfully", 201);
  } catch (e) {
    next(e);
  }
};
...
export const getAll = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get posts successfully");
  } catch (e) {
    next(e);
  }
};
...
export const getById = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get post successfully");
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Update post successfully");
  } catch (e) {
    next(e);
  }
};
...
export const remove = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Remove post successfully");
  } catch (e) {
    next(e);
  }
};
