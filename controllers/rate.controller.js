...
export const create = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Create rate successfully", 201);
  } catch (e) {
    next(e);
  }
};
...
export const getAll = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get rates successfully");
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Update rate successfully");
  } catch (e) {
    next(e);
  }
};
...
export const remove = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Remove rate successfully");
  } catch (e) {
    next(e);
  }
};
...
export const findAndPaginate = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get rates with pagination successfully");
  } catch (e) {
    next(e);
  }
};
