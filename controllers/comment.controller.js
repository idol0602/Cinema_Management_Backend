...
export const create = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Create comment successfully", 201);
  } catch (e) {
    next(e);
  }
};
...
export const getAll = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get comments successfully");
  } catch (e) {
    next(e);
  }
};
...
export const getById = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get comment successfully");
  } catch (e) {
    next(e);
  }
};
...
export const update = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Update comment successfully");
  } catch (e) {
    next(e);
  }
};
...
export const remove = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Remove comment successfully");
  } catch (e) {
    next(e);
  }
};
...
export const findAndPaginate = async (req, res, next) => {
  try {
    ...
    return success(res, data, "Get comments with pagination successfully");
  } catch (e) {
    next(e);
  }
};
